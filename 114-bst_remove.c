 ...
 * @node: Pointer to the node to delete from BST
 ...
 * @value: Vale to remove from the BST
 * Return: Pointer to the root node after deleteion
 */
 ...
 * Return: Pointer to the new root node after deleteion
 */
bst_t *bst_remove(bst_t *root, int value)
{
	return (bst_removr_recursive(root, root, value));
}
