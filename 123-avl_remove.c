...
/**
 * successor - gets next successor, i.e, min node in the right subtree
 * @node: tree to cehck
...
/**
 * remove_type- removes a node depending on it's children
 * @root: node to remove
 * Return: 0 if it has no children, other value otherwise
 */
